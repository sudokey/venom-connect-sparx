  ...
  public connect = (): Promise<any> =>
    new Promise(async (resolve, reject) => {
      ...
      if (!authList || !authList.length) {
        ...
        } else if (this.checkIsWalletBrowser().isSparxWalletBrowser) {
          await this.connectTo("sparxwallet", "extension");
  ...
  private checkIsWalletBrowser = () => {
    ...
    return {
      ...
      isOneOfWalletBrowsers:
        isVenomWalletBrowser || isEverWalletBrowser || isSparxWalletBrowser || isOxyWalletBrowser || isOneartWalletBrowser,
    };
  };
